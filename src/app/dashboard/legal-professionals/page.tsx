...
export default function LegalProfessionalsPlaceholderPage() {
  return (
    <div className="space-y-6 max-w-2xl mx-auto py-8">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-primary tracking-tight">提携士業管理</h1>
      </div>
        ...
        <CardHeader className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <CardDescription className="max-w-md mx-auto text-sm">
              行政書士・弁護士など、各企業に紐づく士業情報を登録・管理するモジュールです。現在開発に向けた設計フェーズです。
            </CardDescription>
          </div>
        </CardHeader>
